        ...
        <div className="row p-5 mt-5  border-top">
          <div className="col-8 p-4 ">
            ...
            <ul className="text-muted" style={{lineHeight:"2.5",fontSize:"12px"}}>
              <li>
                Call & Trade and RMS auto-squareoff:Aditional charger of ₹50 +
                GST per order.
              </li>
              <li>Digital contract notes will be sent via e-mail.</li>
              <li>
                Physical copies of contract nnotes, if required, shall be
              ...
              <li>
                If the account is in debit balance, any oredr placed will be
